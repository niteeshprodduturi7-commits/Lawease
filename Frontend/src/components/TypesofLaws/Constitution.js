const Constitution = () => {
  return ( 
     ...
     <header className="law-article__title">CONSTITUTION LAW</header>
      <div className="law-article__body">
